...
export const NotFound = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-2xl">
                ...
                <div className="space-y-6 mb-12">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 max-w-md mx-auto leading-relaxed">
                        Oops! The page you're looking for has wandered off into
            ...
            {/* Floating Elements */}
            <div
                className="absolute top-20 left-10 w-20 h-20 border border-indigo-500/30 rounded-lg rotate-45 animate-bounce"
                style={{ animationDuration: "3s" }}
            ></div>
            <div
                className="absolute bottom-20 right-10 w-16 h-16 border border-purple-500/30 rounded-full animate-bounce"
                style={{ animationDuration: "4s", animationDelay: "1s" }}
            ></div>
            <div
                className="absolute top-1/3 right-20 w-12 h-12 border border-pink-500/30 rounded-lg animate-spin"
